...
class LogiInView extends StatefulWidget {
  const LogiInView({Key? key}) : super(key: key);
                ...
                child: Column(
                  children: [
                          ...
                          child: GestureDetector(
                            ...
                            child: RichText(
                              text: const TextSpan(
                                ...
                                children: [
                                  TextSpan(text: 'Remainder ', style: TextStyle(color: Colors.indigo, fontWeight: FontWeight.w600)),
                                ],
                              ),
                            ),
                          ),
                    ...
                    Row(
                      ...
                      children: [
                        const Text('Not yet Account'),
                        TextButton(onPressed: (){
                          context.push(Routes.REG_SCREEN);
                        }, child: const Text('Reg Now!')),
                      ],
                    ),
